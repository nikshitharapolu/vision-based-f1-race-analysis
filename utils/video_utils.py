...
# Detect movement direction once for the whole video 
...
def draw_annotations(
    ...
    for fi, frame in enumerate(frames):
        ...
        # 2. Mini-map overlay (disabled for now)
        ...
        # 4. Commentary box — drawn onto sidebar 
        ...
        # Detect direction locally per frame to handle camera angle changes
...
def _rank_key(bbox: list[float], direction: str) -> float:
    ...
    if direction == "right":
        ...
        return cy         # highest on screen = leading
...
def _build_top3_panel(
    ...
    trophy_colors = [(0, 215, 255), (0, 185, 192), (0, 140, 105)] 
...
def _build_chat_sidebar(
    ...
    Returns: image is stacked horizontally next to the video frame —
